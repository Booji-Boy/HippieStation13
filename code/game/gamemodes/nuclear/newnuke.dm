...
var/global/list/corplist = list("Ten0 - Stealth", "BlastCo - Explosions", "Engineering - Building", "A.S.S. - Power", "Syndicate - Regular")
...
/datum/game_mode/proc/corp(mob/living/carbon/human/synd_mob)
	spawn(0)
		var/radio_freq = SYND_FREQ
		var/result = input(usr, "Please choose a corporation to join","Corporation") as null|anything in corplist
		switch(result)
			if("Ten0")
				synd_mob << "The Ten0 is a Corporation developed around stealth. By alt-clicking with your suit on, you will teleport!"
				var/obj/item/device/radio/R = new /obj/item/device/radio/headset/syndicate/alt(synd_mob)
				R.set_frequency(radio_freq)
				synd_mob.equip_to_slot_or_del(R, slot_ears)
			...
			if("BlastCo")
				synd_mob << "From the makers BlastCo comes Space Michael Bay. Rollerblade your way with explosives and a suit mounted grenade launcher!"
				var/obj/item/device/radio/R = new /obj/item/device/radio/headset/syndicate/alt(synd_mob)
				R.set_frequency(radio_freq)
				synd_mob.equip_to_slot_or_del(R, slot_ears)
			...
			if("A.S.S.")
				synd_mob << "Rip and tear the station a new one, what's subtlety when you go BANGPOWBOOM!"
				var/obj/item/device/radio/R = new /obj/item/device/radio/headset/syndicate/alt(synd_mob)
				R.set_frequency(radio_freq)
				synd_mob.equip_to_slot_or_del(R, slot_ears)
